...
public class ConsoleApp {
    ...
    private void agregarCurso() {
        try {
            ...
            // Buscar DTO de Programa en lugar de entidad
            ...
            if (programaSeleccionado != null) {
                // Creamos el DTO de Curso en lugar de la entidad
                CursoDTO nuevo = new CursoDTO(0, nombre, programaSeleccionado, true); // ID es autogenerado
                universityController.agregarCurso(nuevo); // Ahora usa DTO
