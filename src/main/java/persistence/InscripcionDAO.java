...
public class InscripcionDAO implements InscripcionDAOInterface{
    @Override
    ...
    public List<Inscripcion> cargarInscripciones() {
        ...
        String sql = """
            SELECT i.id, i.ano, i.semestre,
                   p.id AS est_id, p.nombres AS est_nombres, p.apellidos AS est_apellidos, p.email AS est_email,
                   e.codigo AS est_codigo, e.activo AS est_activo, e.promedio AS est_promedio,
